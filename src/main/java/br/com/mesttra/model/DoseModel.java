...
public class DoseModel {
    ...
    public DoseModel(Integer id_vacina, String descricao_dose, Integer idade_recomendada_aplicacao) {
	...
	public String toString() {	
		return "id dose = " + id_dose + ", id vacina = " + id_vacina + ", descrição dose = " + descricao_dose + ", idade recomendada aplicacao = " + idade_recomendada_aplicacao;
    }
}